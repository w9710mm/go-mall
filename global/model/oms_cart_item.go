...
type OmsCartItem struct {
	...
	MemberId          int64           `gorm:"column:member_id" json:"member_id" `                     //是否可空:YES
	Quantity          int             `gorm:"column:quantity" json:"quantity" `                       //是否可空:YES 购买数量
	Price             decimal.Decimal `gorm:"column:price" json:"price" `                             //是否可空:YES 添加到购物车的价格
	...
	ProductCategoryId int64           `gorm:"column:product_category_id" json:"product_category_id" ` //是否可空:YES 商品分类
