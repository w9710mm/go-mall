...
type OmsOrder struct {
	...
	TotalAmount           *float64   `gorm:"column:total_amount" json:"total_amount" `                       //是否可空:YES
	PayAmount             *float64   `gorm:"column:pay_amount" json:"pay_amount" `                           //是否可空:YES
	FreightAmount         *float64   `gorm:"column:freight_amount" json:"freight_amount" `                   //是否可空:YES
	...
	DiscountAmount        *float64   `gorm:"column:discount_amount" json:"discount_amount" `                 //是否可空:YES
	...
	Integration           *int       `gorm:"column:integration" json:"integration" `                         //是否可空:YES
	...
	UseIntegration        *int       `gorm:"column:use_integration" json:"use_integration" `                 //是否可空:YES
